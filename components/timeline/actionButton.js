...
export default function ActionButton() {
  return (
    <div className="flex justify-between items-start px-10 py-2 border-b border-t border-slate-600">
      <div className="group flex w-8 h-8 rounded-full hover:bg-slate-700 items-center justify-center">
